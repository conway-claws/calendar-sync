...
# The announcements Doc, exported as plain text. Anonymous fetch works because the
# doc is link-shared; if this starts returning HTML or 403, re-share the doc.
...
LABELS = ("ATHLETICS", "ARTS", "ACADEMICS", "COMMUNITY")
